...
class MonsterLoopTest {
	private MonsterLoop monsterLoop;
	
	@BeforeEach
	void setUp() {
		monsterLoop = new MonsterLoop();
	}
	...
	void test1() {
		...
		final Long calculate = monsterLoop.calculate(input);
		
		assertThat(calculate).isEqualTo(4L);
	}
	...
	void test2() {
		...
		assertThat(calculate).isEqualTo(8L);
	}
...
L.L--.J.L7-7JJL.|-JL-LL-7L|J-L.FJ-JLLLJ.L7J|JJF-7JJ.LJ.L--FJLLJ.J-J-JJ.L--|L-L.L-F.JLFLF-J-|-.L|---LL7JJ.L...|LL.-LF-FLFJJ7---JJJ|JL-J.L-L--
		...
		final Long calculate = monsterLoop.calculateEnclosedTiles(input);
