...
class CubeGameTestResult {
	...
	@Test
	void getResult() {
		int i = this.cubeGame.evaluateGames(new BagConstraints(12, 13, 14), this.input);
		assertThat(i).isEqualTo(2476);
		
		long result = this.cubeGame.getPower(this.input);
		System.out.println(result);
	}
	
	@Test
	void getResultTest() {
		long result = this.cubeGame.getPower(List.of(
